...
export function PuzzleAddEntryPanel({
  ...
  const canSubmit = Boolean(
    placementDraft.cell && placementDraft.wordId && placementDraft.direction && placementValid,
  );

  const baseStatus = getPlacementStatusMessage(placementDraft);
  let statusMessage =
    baseStatus ?? 'Förhandsvisning visas i rutnätet. Bekräfta när placeringen ser rätt ut.';
  ...
  const showDirectionPrompt =
    placementDraft.cell && placementDraft.wordId && !placementDraft.direction;
