...
const stateClasses = {
  ...
  active: 'border-print-green bg-print-green-soft text-print-green shadow-none',
  selected: 'border-print-green bg-print-green-soft text-print-green shadow-none',
  depleted: 'border-print-green bg-print-tile-depleted text-print-green shadow-none',
  success: 'border-print-green bg-print-feedback-success text-print-green shadow-none',
  ...
  present: 'border-print-yellow bg-print-yellow-soft text-print-ink shadow-none',
